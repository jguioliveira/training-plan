    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Plans_Person_InstructorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackingServices", x => new { x.PersonId, x.Name });
                    table.ForeignKey(
                        name: "FK_TrackingServices_Person_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Person",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamSettings", x => new { x.Key, x.TeamId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Workouts_Contents_ContentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SocialMedia_TeamId",
                table: "SocialMedia",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamSettings_TeamId",
                table: "TeamSettings",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_Workouts_ContentId",
                table: "Workouts",
                column: "ContentId");
